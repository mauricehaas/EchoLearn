...
class ExamSimulator:
    def __init__(
        ...
        Args:
            ...
            prompt_case_one (str): Prompt template for case one evaluation.
            prompt_case_two (str): Prompt template for case two evaluation.
            prompt_case_three (str): Prompt template for case three evaluation.
            evaluate_exam (str): Prompt template for evaluating the entire exam.
        """
