...
async def seed():
    ...
    async with async_session() as session:
        ...
        testquestions = [
            ...
            Question(
                question="Was ist 1 + 1 und was ist 2 + 2?",
                answer="1 + 1 ist 2 und 2 + 2 ist 4",
                max_points="5",
            ),
            Question(
                question="Was ist 1 + 1 und was ist 2 + 2 und was 4 + 4?",
                answer="1 + 1 ist 2 und 2 + 2 ist 4 und 4 + 4 ist 8",
                max_points="5",
            ),
        ]
